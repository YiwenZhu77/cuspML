...
## Contents
- `data/cusp_crossings_1987_2014.parquet` — the archived cusp-crossing catalog (48,056 crossings,
...
- `data/omni_dst_hourly_1987_2014.parquet` — hourly Dst (OMNI2/CDAWeb), used only for the
